...
import { Select_Proveedor_Busqueda } from "../DataBase";
import { Loader } from "../Layouts/Loader";
const transparent = "rgba(0,0,0,0.5)";

export function SeleccionarProveedor({ cerrar, actualizarProveedor }) {
  ...
  const Busqueda = async () => {
    SetLoad(true);
    const lista = await Select_Proveedor_Busqueda(InfoRegistrar.Busqueda);
